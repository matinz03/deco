    ...
    <>
      <header className="chat-header">
        ...
        <div className="chat-actions">
          {/* Group settings button — always visible for groups */}
          {isGroup && (
            <button
              className="icon-btn"
        ...
        <AnimatePresence>
          {settingsOpen && isGroup && (
            ...
            >
              ...
              <motion.div
                className="relative z-10 flex flex-col w-full sm:max-w-2xl max-h-[92dvh] sm:max-h-[85dvh] rounded-t-3xl sm:rounded-3xl border border-sidebar bg-surface shadow-2xl overflow-hidden"
              ...
              >
                ...
                <div className="overflow-y-auto flex-1">
                  <div className="grid sm:grid-cols-[1.1fr,0.9fr] gap-0 sm:gap-6 p-5">
                    {/* Left column */}
